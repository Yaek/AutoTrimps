var ATversion='Zek/Yaek v4.0.0',atscript=document.getElementById('AutoTrimps-script'),basepath='https://Yaek.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
...
function initializeAutoTrimps() {
    ...
    debug('AutoTrimps - Zek/Yaek Fork Loaded!', '*spinner3');
}
