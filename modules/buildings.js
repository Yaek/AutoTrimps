...
function buyBuildings() {
    ...
    //Nurseries
    var nurseryGems = getBuildingItemPrice(game.buildings["Nursery"], "gems", false, 6)
    var collectorGems = getBuildingItemPrice(game.buildings["Collector"], "gems", false, 1)
    if (collectorGems>nurseryGems && game.buildings.Nursery.locked == 0 && (!hidebuild &&( game.global.world >= getPageSetting('NoNurseriesUntil') || getPageSetting('NoNurseriesUntil') < 1) && (getPageSetting('MaxNursery') > game.buildings.Nursery.owned || getPageSetting('MaxNursery') == -1)) || (game.global.challengeActive != "Daily" && getPageSetting('PreSpireNurseries') > game.buildings.Nursery.owned && isActiveSpireAT()) || (game.global.challengeActive == "Daily" && getPageSetting('dPreSpireNurseries') > game.buildings.Nursery.owned && disActiveSpireAT())) {
